...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \textbf{Processing:}
      \begin{itemize}
        \item Created Master Bias using Median combination, run basic statistic.
        \item Purpose: Analyze read noise and remove fixed-pattern noise.
      \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \textbf{Processing:}
      \begin{itemize}
        \item Subtract master zero, run basic statistic.
        \item Purpose: Analyze dark current noise, map hot pixels.
      \end{itemize}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{../img/dark_hot_pixels_big.png}
...
\begin{figure}[htbp]
	\begin{itemize}
		...
		\item CLV doesn't apply here - Can't model just as Gaussian.
	\end{itemize}
	\begin{center}
  ...
  \begin{itemize}
    \item \textbf{Dataset Description:}
      \begin{itemize}
        ...
        \item Exposures: Series of frames with varying exposure times (0.1s -- 10s).
        \item Count: 60+ frames covering whore dynamic range
      \end{itemize}
    \item \textbf{Objective:} Calculate Gain ($g$) in $\mathrm{e}^{-}\mathrm{ADU}^{-1}$ using:
      \begin{equation}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item \textbf{Result:} Failed due to lack of high-signal data (<6000 ADU), weird effects.
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{figure}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        ...
        \caption{Spatial Photon Transfer Curve displaying incoherent variance vs signal.}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
