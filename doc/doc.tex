...
\begin{abstract}
Following paper concerns itself with analysis of parameters of a coudé CCD 700~mm spectrograph connected to a Perek 2 meter optical telescope in Ondřejov Observatory. Analysis of zeros, darks and flatfields was done in order to estimate noise parameters, pixels uniformity and sensors gain.
\end{abstract}
