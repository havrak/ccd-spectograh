...
b = robustfit(allMeans, allVars);
slope = b(2);
intercept = b(1); % should be zeroResults.globalReadNoise^2 higher

% Invert slope to get Gain
gainVal = 1 / slope;
